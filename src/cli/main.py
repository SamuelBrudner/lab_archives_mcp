...
def main() -> None:
    ...
    try:
        ...
        try:
            ...
            logger.error(
                f"Unexpected error parsing CLI arguments: {str(e)}",
                extra={
                    'operation': 'main',
                    'event': 'args_parse_error',
                    'error': str(e),
        ...
        try:
            ...
            # Log to audit logger
            audit_logger.info(
                "LabArchives MCP Server startup initiated",
                extra={
        ...
        try:
            ...
            logger.error(
                f"Failed to initialize authentication manager: {str(e)}",
                extra={
                    'operation': 'main',
        ...
        logger.info(
            ...
            extra={'operation': 'main', 'event': 'authentication_start'},
        )
        ...
        logger.info(
            ...
            extra={'operation': 'main', 'event': 'resource_manager_init'},
        )
        ...
        try:
            ...
            logger.error(
                f"Failed to initialize resource manager: {str(e)}",
                extra={
                    'operation': 'main',
        ...
        logger.info(
            ...
            extra={'operation': 'main', 'event': 'signal_handlers_init'},
        )
        ...
        try:
            ...
            logger.error(
                f"Failed to register signal handlers: {str(e)}",
                extra={
                    'operation': 'main',
        ...
        logger.info(
            ...
            extra={'operation': 'main', 'event': 'mcp_server_init'},
        )
        ...
        try:
            ...
            logger.error(
                f"Failed to run MCP server: {str(e)}",
                extra={
                    'operation': 'main',
        ...
        if logger:
            logger.info(
                f"LabArchives MCP Server process terminating with exit code {exit_code}",
                extra={
                    'operation': 'main',
