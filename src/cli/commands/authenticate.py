...
def authenticate_command(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        logger.info(
            "Starting authentication command",
            extra={
        ...
        logger.info(
            "Attempting to establish authentication session",
            extra={
                'component': 'authenticate_command',
        ...
        if session and session.is_valid():
            ...
            logger.error(
                "Authentication failed with invalid session",
                extra={
                    'component': 'authenticate_command',
                    'operation': 'establish_session',
                    'result': 'failure',
        ...
        if logger:
            logger.error(
                "Authentication failed with LabArchivesMCPException",
                extra={
                    'component': 'authenticate_command',
                    'operation': 'establish_session',
                    'result': 'failure',
        ...
        if logger:
            logger.info(
                "Authentication command completed",
                extra={'component': 'authenticate_command', 'operation': 'complete'},
            )
