...
- Start a project context (`create_project`) for multi-session work; state persists to `~/.labarchives_state/session_state.json`. Visits and findings only record when a project is active.
